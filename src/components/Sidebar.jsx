...
export default function Sidebar(props) {
  return (
    <div className='lg:w-[35%] md:w-[100%] h-[70%] w-[90%] flex-wrap lg:h-full md:bg-[url(../src/assets/images/bg-sidebar-mobile.svg)] bg-[url(../src/assets/images/bg-sidebar-mobile.svg)] bg-cover lg:bg-contain lg:bg-[url(../src/assets/images/bg-sidebar-desktop.svg)] bg-no-repeat flex lg:flex-col'> 
