...
export default function Thanks(props) {
  return (
    <div className='w-[500px] flex flex-col gap-[20px] lg:gap-[70px] justify-center items-center md:w-[500px] md:items-center lg:w-[70%]'>
        <div className='w-[90%] flex flex-col justify-center items-center text-center pt-[25px] gap-[20px] lg:gap-[30px] md:items-center md:h-[340px]'>
